...
<head>
  ...
  <link href="//cdn.shopify.com/s/files/1/0081/7132/3474/t/9/assets/bundle.css?v=876308085821643255" rel="stylesheet" type="text/css" media="all">
  <link href="//cdn.shopify.com/s/files/1/0081/7132/3474/t/9/assets/custom.scss.css?v=16237437915905883943" rel="stylesheet" type="text/css" media="all">
</head>
  ...
  const params = {
    ...
    Message: { /* required */
      Body: { /* required */
        Html: {
         Charset: "UTF-8",
         Data: `<h1>Thanks for your message:</h1>\n\n
    ...
    Source: 'blamb888@gmail.com', /* required */
    ReplyToAddresses: [
       'blamb888@gmail.com',
      /* more items */
    ],
...
// const SES_FROM_EMAIL_ADDRESS = "blamb888@gmail.com";
...
//     console.log("These are the EMAIL PARAMS: " + emailParams);
...
//       }).catch(
//         function(err) {
//         console.error("Something went terribly wrong" + err, err.stack);
//       });
// }
